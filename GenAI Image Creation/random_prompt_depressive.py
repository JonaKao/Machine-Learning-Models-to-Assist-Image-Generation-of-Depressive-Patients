...
genders         = ["man", "woman"]
expressions     = ["moderate", "strong", "very strong"]
...
def generate_prompt():
    ...
    return (
        ...
        f"The person's eyes are half-lidded, lacking focus, with a faint downward tilt. "
        f"The overall facial tone is still, as if the muscles are too tired to express. "
        f"The head tilts downward slightly, and the face carries a sense of emotional heaviness. "
